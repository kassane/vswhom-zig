...
#if LIBEXTERN 
    #define LIBEXTERN __declspec(dllexport)
#else
    #define LIBEXTERN __declspec(dllimport)
#endif
...
extern "C" {
    ...
    LIBEXTERN void vswhom_free_resources(Find_Result *result) {
...
extern "C" LIBEXTERN Find_Result vswhom_find_visual_studio_and_windows_sdk() {
    Find_Result result{};
